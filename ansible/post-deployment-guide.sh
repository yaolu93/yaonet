...
echo "========================================="
echo "  Yaonet Ansible Deployment Complete"
echo "=========================================="
echo ""
...
echo "ssh ubuntu@$WEBSERVERS tail -f /var/log/yaonet/error.log"
echo ""
echo "# Check database"
...
echo "   Edit: /etc/nginx/sites-available/yaonet"
echo ""
...
echo "MONITORING:"
echo "==========="
echo "Application logs: /var/log/yaonet/error.log"
echo "Access logs: /var/log/yaonet/nginx/access.log"
